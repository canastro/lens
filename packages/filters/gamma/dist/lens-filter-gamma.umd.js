!(function(e, t) {
    'object' == typeof exports && 'undefined' != typeof module
        ...
        : 'function' == typeof define && define.amd
            ...
            : t((e.lensFilterGamma = {}), e.workerize);
})(this, function(e, n) {
    'use strict';
    ...
    var t,
        ...
        r = function(e) {
            for (
                var t = e.data, n = e.length, a = e.options, o = 0;
                o < n;
                o += 4
            )
                (t[o] = 255 * Math.pow(t[o] / 255, a.level)),
                    (t[o + 1] = 255 * Math.pow(t[o + 1] / 255, a.level)),
                    (t[o + 2] = 255 * Math.pow(t[o + 2] / 255, a.level));
            return t;
        };
    (e.transform = r),
        (e.default = function() {
